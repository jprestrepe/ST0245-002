...
public class Test{
    ...
    public static void almacenSolicitudes(){
        Stack<String> neveras = new Stack<String>();
        Queue<String[]> almacenes = new LinkedList<String[]>();
        String[] arrNeveras = {"Nevera1:10001","Nevera2:10002","Nevera3:10003",
                            "Nevera4:10004","Nevera5:10005","Nevera6:10006"};
        String[][] arrAlmacenes = {{"Almacen1","1"},{"Almacen2","2"},{"Almacen3","3"}};
        for(String item:arrNeveras){
            neveras.push(item);
        }  
    ...
    public static void main(String[] args){
        ...
        //Ejercicio1
        if(ejercicio1()) System.out.println("Ejercicio 1 Correcto");
        else System.out.println("Ejercicio 1 Incorrecto");
        
        //Ejercicio2
        ejercicio2();
        
        //Ejercicio3
        if(ejercicio3()) System.out.println("Ejercicio 3 Correcto");
        else System.out.println("Ejercicio 3 Incorrecto");
